...
- Name: metrics.spec.ts >> Metrics & Components Functionality >> Renders AI Sentiment and Economic Calendar components
- Location: tests\e2e\metrics.spec.ts:52:7
...
Locator: getByRole('heading', { name: /Market Overview/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /Market Overview/i })
